...
`);if(!o){alert("لا توجد موضوعات مكتوبة لتصديرها.");return}const r=new Blob(["\uFEFF"+o],{type:"text/plain;charset=utf-8;"});Y(r,"topics.txt")},Y=(t,o)=>{const r=URL.createObjectURL(t),n=document.createElement("a");n.href=r,n.download=o,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(r)},ne=()=>`
    ...
    /* Logo sizing */
    img.header-logo-img { height: 75px !important; width: auto !important; object-fit: contain !important; }
...
`,Ee=async t=>{const o=document.getElementById("printable-area-content"),{meta:r,title:n}=t,{useEasternDigits:i}=r;if(!o){alert("حدث خطأ: لا يمكن العثور على المحتوى للتصدير.");return}const h=`
...
`,j=new Blob([E.trim()],{type:"text/html;charset=utf-8;"}),L=`school_plan_${t.startDate||"new"}.html`;Y(j,L)},te=t=>{var d,m;const o=document.getElementById("printable-area-content"),r=(d=document.getElementById("printable-header-content"))==null?void 0:d.innerHTML,n=(m=document.getElementById("printable-footer-content"))==null?void 0:m.innerHTML;if(!o||!r||!n){alert("حدث خطأ أثناء محاولة الطباعة.");return}const i=o.cloneNode(!0);i.querySelectorAll("textarea[data-row-index]").forEach(c=>{var I;const l=c,u=document.createElement("div");u.style.whiteSpace="pre-wrap",u.style.wordWrap="break-word",u.textContent=l.value;const E=l.disabled,j=l.closest("tr"),L=j&&j.classList.contains("print:hidden");u.className=`p-2 w-full h-full ${E||L?"text-center":""}`,(I=l.parentNode)==null||I.replaceChild(u,l)});const h=Array.from(document.querySelectorAll("style")).map(c=>c.innerText).join(`
